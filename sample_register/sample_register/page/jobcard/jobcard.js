...
sample_register.JobCard = Class.extend({
	...
	submit_job_card: function(){
		...
		frappe.call({
			method: "sample_register.sample_register.page.jobcard.jobcard.submit_job_card",
			args: {
				"selectedData":selectedData
			},	
			callback: function(r) {
		...
		console.log(data1)
		    ...
		    for (var i = 0; i<data1.get_sample_data.length; i++) {
		      data[i] = {
		        ...
		        job_card: data1.get_sample_data[i][6],
		        job_card_status: data1.get_sample_data[i][7],
		        test_group: data1.get_sample_data[i][8]
		      };
		    }
		    grid = new Slick.Grid("#myGrid", data, columns, options);
			    ...
			    {id: "job_card_status", name: "Job Card Status", field: "job_card_status",minWidth:120}
